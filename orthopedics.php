...
<body>
 ...
 <header>
	...
	<div class="container-color">
		...
		<img src="src\images\ortho.jpg" class = "mainlogo" id="redheart" height="100px" width="150px">
		...
		<div class="row">
			<div class="col-12 heading1" style="margin-top:40px;">
				...
				<h1 style="font-size:45px;">Orthopedics Department</h1>
			</div>
		</div>
		...
		<div class="row">
			<button class="collapsible">Read More About Orthopedics Department</button>
				<div class="content">
					<h3 style="margin-top:20px">Facilities provided </h3>
					<p align="justify">
						The orthopedics department facilitates:<br>
						<ul>
							<li>Clinic providing foot and ankle, hand and upper extremity</li>
							<li>Joint reconstruction and replacement, orthopedic spine</li>
