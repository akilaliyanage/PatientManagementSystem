	...
	<div class="container-color">
		...
		<div class="row">
			<div class="col-12 heading1" style="margin-top:40px;">
				...
				<h1 style="font-size:45px;">General Surgery Department</h1>
			</div>
		</div>
		...
		<div class="row">
			...
			General surgery is a surgical specialty that focuses on abdominal contents including esophagus, stomach, small intestine, large intestine,
			liver, pancreas, gallbladder, appendix and bile ducts, and often the thyroid gland. 
			They also deal with diseases involving the skin, breast, soft tissue, trauma, peripheral vascular surgery and hernias
			and perform endoscopic procedures such as gastroscopy and colonoscopy.
			</h3>
			</p>
		</div>
		
		<div class="row">
			<button class="collapsible">Read More About General Surgery Department</button>
				<div class="content">
					<h3 style="margin-top:20px">Facilities provided </h3>
					<p align="justify">
						The general surgery department facilitates:<br>
						<ul>
						<li>Abdomino Perinial Resection (APR)</li>
						<li>Hepatectomy</li>
						<li>Thyrodectomy</li>
						<li>Tripple Bypass</li>
						<li>Submandibular Gland Excision</li>
