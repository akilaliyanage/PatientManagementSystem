...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="src\style\department-index-back.css">
                        ...
                        <div class="button-links">
                                ...
                                <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                          ...
                                          <a onclick="department(5)">ORTHEOPEDICS</a>
        ...
        <div class="head">
            ...
            <div class="container-color">
                <div class="row">
                    ...
                    <div class="col-10" style="margin-top:100px; margin-left:0px;">
                        <div class="slider">
                              <div class="slide card" id="slide-1">
                                    <h5 class = "topic"> <b><a onclick="department(1)" style="text-decoration:none" onclick="department('card')">CARDIOLOGY</a></b></h3>
                                    <a onclick="department(1)"><img src="src/images/blu.png" height = "120" width="120" class="logo"></a>
                              ...
                              <div class="slide card" id="slide-2">
                                    <h5 class = "topic"> <b><a onclick="department(2)" style="text-decoration:none">orthopedics</a></b></h3>
                                    <a onclick="department(2)"><img src="src/images/ortho.jpg" height = "120" width="120" class="logo"></a>
                              ...
                              <div class="slide card" id="slide-3">
                                    <h5 class = "topic"> <b><a  onclick="department(3)" style="text-decoration:none"> General surgery</a></b></h3>
                                    <a  onclick="department(3)"><img src="src/images/surgery.png" height = "120" width="120" class="logo"></a>
                              ...
                              <div class="slide card" id="slide-4">
                                    <h5 class = "topic"> <b><a  onclick="department(4)" style="text-decoration:none"> Gastroenterology</a></b></h3>
                                    <a  onclick="department(4)"><img src="src/images/gast.png" height = "120" width="120" class="logo"></a>
                              ...
                              <div class="slide card" id="slide-5">
                                    <h5 class = "topic"> <b><a onclick="department(5)" style="text-decoration:none">dermatology</a></b></h3>
                                    <a onclick="department(5)"><img src="src/images/derma.png" height = "120" width="120" class="logo"></a>
