...
<body>
 ...
 <header>
	...
	<div class="container-color">
		...
		<img src="src\images\heart2.jpg" class = "mainlogo" id="redheart" height="150px" width="200px">
		...
		<div class="row">
			<div class="col-12 heading1" style="margin-top:40px;">
				...
				<h1 style="font-size:45px;">Dermatalogy Department</h1>
			</div>
		</div>
		...
		<div class="row">
			<button class="collapsible">Read More About Dermatology Department</button>
				<div class="content">
					<h3 style="margin-top:20px">Facilities provided </h3>
					<p align="justify">
						The dermatology department facilitates:<br>
						<ul>
							<li>Allergy testing – 'Patch testing' for contact dermatitis.</li>
							<li>Chemical peels for the treatment of acne, melasma, and sun damage</li>
							<li>Cryosurgery – for the treatment of warts, skin cancers, and other dermatosis.</li>
							<li>Phototherapy – including the use of narrowband UVB, broadband UVB, psoralen and UVB.</li>
							<li>Cosmetic filler injections.</li>
							 <li>Excision and treatment of skin cancer.</li>
						</ul>
					</p>
				</div>
		</div>
